...
struct InsightsView: View {
    ...
    private func categoryName(_ category: GroceryCategory) -> String {
        ...
        case .spanish:
            ...
            case .grain: "Granos y pasta"
            case .condiment: "Salsas y condimentos"
            case .canned: "Conservas"
            case .frozen: "Congelados"
            case .prepared: "Comidas preparadas"
